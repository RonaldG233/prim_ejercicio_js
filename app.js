...
// Estas funciones realizan diferentes acciones relacionadas con posts, tareas y usuarios.
...
// Se define una funcion asincrona llamada Copmpleto, que es la funcion principal del programa, q se le asignara en general 
// para saber el resultado completo
async function  Completo() {
    // Se muestra un cuadro de texto al usuario para que elija una opcion
    // prompt permite que el usuario escriba un numero para elegir un ejercicio
...
// Se llama a la funcion Completo para que el programa inicie su ejecucion
Completo();
